...
![](https://github.com/BBBoundary/BBBoundary.github.io/blob/master/img/CV/CV_CAM-img1.png)

​	②Text Attention Module: 【对照组：Visual-RNN、VT-RNN】由描述结果可看出CAM-RNN生成的描述更少有语法错误：

![](https://github.com/BBBoundary/BBBoundary.github.io/blob/master/img/CV/CV_CAM-img2.png)

​		另外，对于短语级别的注意力机制，模型通过在MSVD、charades上的训练，得到S=3(注意力范围，即可用的prewords)为最佳：

![](https://github.com/BBBoundary/BBBoundary.github.io/blob/master/img/CV/CV_CAM-img3.png)

​	③Balancing gate：CAM-RNN与VT-RNN的唯一区别即在于平衡门的有无，从TableI、TableII中也可看出平衡门的有效性。
![](https://github.com/BBBoundary/BBBoundary.github.io/blob/master/img/CV/CV_CAM-img4.png)

#### 2）Results on MSVD

①各种模型在CIDer、BLEU、ROUGE-L、METEOR数据及上的测试结果：

![](https://github.com/BBBoundary/BBBoundary.github.io/blob/master/img/CV/CV_CAM-img5.png)
...
![](https://github.com/BBBoundary/BBBoundary.github.io/blob/master/img/CV/CV_CAM-img6.png)

#### 3）Results on Charades

【对照组：S2VT、SA、MAAM】在Charades上的表现：

![](https://github.com/BBBoundary/BBBoundary.github.io/blob/master/img/CV/CV_CAM-img7.png)
...
![](https://github.com/BBBoundary/BBBoundary.github.io/blob/master/img/CV/CV_CAM-img8.png)
...
![](https://github.com/BBBoundary/BBBoundary.github.io/blob/master/img/CV/CV_CAM-img9.png)
...
![](https://github.com/BBBoundary/BBBoundary.github.io/blob/master/img/CV/CV_CAM-img10.png)
