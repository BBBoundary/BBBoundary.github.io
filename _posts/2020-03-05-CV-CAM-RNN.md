...
![](/img/CV_CAM-img6.png){:height="50%" width="50%"}

#### 3）Results on Charades

【对照组：S2VT、SA、MAAM】在Charades上的表现：

![](/img/CV_CAM-img7.png){:height="50%" width="50%"}
...
![](/img/CV_CAM-img8.png){:height="50%" width="50%"}
